                            ...
                            if ($user_login!==''){
                                if($user_role=='admin'){
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr><td>" . $row["user_id"]. "</td><td>" . $row["login"] . 
                                        "</td><td>" . $row["role"] . "</td><td>";
                                        echo '<input type="submit" value="Promote to admin" class="button" name="admin" id="'. $row["user_id"] .'"/>';
                                        echo '<input type="submit" value="Remove permission" class="button" name="admin" id="'. $row["user_id"] .'"/>';
                                    }
