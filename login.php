    ...
    <nav class="navbar navbar-expand-lg navbar-light text-white" style="background-color: #e3f2fd;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php
                if( $user_login !== '' ){
                    $user_role = isset($_SESSION['role']) ? $_SESSION['role'] : '';
                    echo("<span class='navbar-text text-blue'>");
                    echo("&emsp; &emsp; &emsp;");
          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">Festival</h4>
                </div>
                <!-- <form class="form" method="post" name="login"> -->
                <form action = "login_redirect.php" class="form" method="POST">
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">tu mozna prezentować zdjęcia artystów albo jakiś  najs napis</h4>
