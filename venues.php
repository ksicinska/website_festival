        ...
        <div class="p-3 mb-2 mt-2 bg-light text-dark">
            <h3>Our venues</h3>
                <table class="p-3 mb-2 mt-2 bg-light text-dark">
                    <tr>
                        <th class="venues"> Venue ID </th>
                        <th class="venues"> Venue Name </th>
                        <th class="venues"> Location </th>
                    </tr>
                    ...
                    <?php
                        ...
                        if($result->num_rows >0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["venue_id"]. "</td><td>" . $row["venue_name"] . 
                                "</td><td>" . $row["description"] . "</td><td>";
                            }
                            echo "</table>";
                        }
                        else {echo "Error 404";
                        ...
                        // foreach ($result as $v) {
                        //     echo $v["date"]."" .$v["time"]." ".$v["venue_name"]." ".$v["artist"]." ";
                        //     echo '<input type="submit" value="insert" class="button" name="insert" id="'. $v["event_id"] .'"/>';
                        //     echo "<br/>";
                        // }
                        // $result->free();
